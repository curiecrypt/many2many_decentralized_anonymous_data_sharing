...
fg = open("results/benches_single/generate_sig_file" + str(ring_size) + ".txt", "a")
fc = open("results/benches_single/check_sig_file" + str(ring_size) + ".txt", "a")
...
for i in range(nr_signers):
    ...
    fg.write(str(cputime(subprocesses=True) - t) + "\n")
    ...
    fc.write(str(cputime(subprocesses=True) - t) + "\n")
    ####################
...
fr = open("results/benches_single/related_sig_files" + str(ring_size) + ".txt", "a")
fv = open("results/benches_single/verify" + str(ring_size) + ".txt", "a")
...
for i in range(nr_signers):
    ...
    fr.write(str(cputime(subprocesses=True) - t) + "\n")
    ...
    if (len(related_sig_files)) > 0:
        ...
        if ver == 1:
            ...
            ver_cnt += 1
        fv.write(str(cputime(subprocesses=True) - t) + "\n")
